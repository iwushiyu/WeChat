...
<div class="demoTable" style="margin-top: 10px ;margin-left: 10px">
	<blockquote class="layui-elem-quote">
		...
		<a href="javascript:;" style="float: right;margin-right: 40px" id="add-video" class="layui-btn"><i class="layui-icon layui-icon-add-1"></i>新增视频素材</a>
	</blockquote>
</div>
<div style="padding: 20px; background-color: #F2F2F2; min-height: 485px;">
	<div class="layui-row layui-col-space15">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
			<legend>视频素材，<span id="count">共（0</span>）条<span id="point" style="font-size: 12px; position: relative; left: 20px;">支持MP4格式，小于10M</span></legend>
		</fieldset>
...
//                maxmin: false,
				...
				content: './selectFans.jsp?messageId=' +videoID+'&messageType=video&mark=material'
			});
