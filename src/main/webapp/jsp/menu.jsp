...
<head>
	...
	<link rel="stylesheet" href="../statics/assets/css/font-awesome.min.css">
	<!-- 自定义样式 -->
	<link rel="stylesheet" href="../statics/assets/css/wx-custom.css">
	<!--[if lt IE 9]>
...
<div class="container">
    ...
    <script src="../statics/assets/js/jquery-1.11.1.min.js"></script>
    <script src="../statics/assets/js/bootstrap.min.js"></script>
	<!-- 自定义菜单排序 -->
	<script src="../statics/assets/js/Sortable.js"></script>
	<script src="../statics/assets/js/menu.js"></script>
						...
						<div class="panel panel-default">
							<div class="panel-heading msg-date">
						  	...
						  	<div class="panel-body">
						    	...
						    	<div class="msg-img"><img src="../statics/assets/images/20170831595cf16beb634972a65adb6b14abca9b.jpg" alt=""></div>
						...
						<div class="panel panel-default">
							<div class="panel-heading msg-date">
						  	...
						  	<div class="panel-body">
						    	...
						    	<div class="msg-img"><img src="../statics/assets/images/1.png" alt=""></div>
						    	<p class="msg-text">微信缴费使用指南</p>
						  	</div>
						  	<div class="mask-bg"><div class="mask-icon"><i class="icon-ok"></i></div></div>
						</div>
